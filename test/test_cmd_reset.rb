...
class TestCmdSet < Test::Unit::TestCase
  def test_cli_parse
    ...
    assert_equal parsed.cmd.class, CmdReset
    assert_equal parsed.cmd.name, 'foo'
    assert_equal parsed.cmd.helper.class, CmdSet
  ...
  def test_cli_parser
    ...
    assert_equal parsed.cmds[0].cmd.class, CmdReset
    assert_equal parsed.cmds[0].cmd.name, 'foo'
    assert_equal parsed.cmds[0].cmd.helper.class, CmdSet
